...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net dataflow_0_m_axi_AXI_M_0 [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins dataflow_0/m_axi_AXI_M_0]
  connect_bd_intf_net -intf_net dataflow_0_m_axi_AXI_M_1 [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins dataflow_0/m_axi_AXI_M_1]
  connect_bd_intf_net -intf_net dataflow_0_m_axi_AXI_M_2 [get_bd_intf_pins axi_smc/S02_AXI] [get_bd_intf_pins dataflow_0/m_axi_AXI_M_2]
  connect_bd_intf_net -intf_net dataflow_0_m_axi_AXI_M_3 [get_bd_intf_pins axi_smc/S03_AXI] [get_bd_intf_pins dataflow_0/m_axi_AXI_M_3]
  connect_bd_intf_net -intf_net dataflow_0_m_axi_WEIGHT [get_bd_intf_pins axi_smc/S04_AXI] [get_bd_intf_pins dataflow_0/m_axi_WEIGHT]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins dataflow_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
