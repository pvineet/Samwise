...
proc create_root_design { parentCell } {
  ...
  # Create instance: dataflow_v2_0, and set properties
  set dataflow_v2_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:dataflow_v2:1.0 dataflow_v2_0 ]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dataflow_v2_0/s_axi_CTRL_BUS/Reg] SEG_dataflow_v2_0_Reg
