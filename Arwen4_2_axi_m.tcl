...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net dataflow_0_m_axi_WEIGHT [get_bd_intf_pins dataflow_0/m_axi_WEIGHT] [get_bd_intf_pins smartconnect_0/S06_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40420000 [get_bd_addr_spaces dataflow_0/Data_m_axi_WEIGHT] [get_bd_addr_segs axi_dma_2/S_AXI_LITE/Reg] SEG_axi_dma_2_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dataflow_0/Data_m_axi_WEIGHT/SEG_axi_dma_2_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x40430000 [get_bd_addr_spaces dataflow_0/Data_m_axi_WEIGHT] [get_bd_addr_segs axi_dma_3/S_AXI_LITE/Reg] SEG_axi_dma_3_Reg
  exclude_bd_addr_seg [get_bd_addr_segs dataflow_0/Data_m_axi_WEIGHT/SEG_axi_dma_3_Reg]
  ...
  exclude_bd_addr_seg [get_bd_addr_segs dataflow_0/Data_m_axi_WEIGHT/SEG_processing_system7_0_HP1_DDR_LOWOCM]
